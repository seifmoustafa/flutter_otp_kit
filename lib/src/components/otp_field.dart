...
class _OtpFieldState extends State<OtpField> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(OtpField oldWidget) {
    ...
    if (oldWidget.fieldColors.borderColor != widget.fieldColors.borderColor ||
        oldWidget.fieldColors.backgroundColor != widget.fieldColors.backgroundColor ||
      ...
      builder: (context, child) {
        ...
        if (widget.config.fieldShape == OtpFieldShape.custom && 
          ...
          decoration = BoxDecoration(
            color: _backgroundColorAnimation.value ?? widget.fieldColors.backgroundColor,
            border: Border(
              bottom: BorderSide(
          ...
          decoration = BoxDecoration(
            borderRadius: BorderRadius.circular(
              widget.config.fieldShape == OtpFieldShape.circle || widget.config.fieldShape == OtpFieldShape.stadium
                  ...
                  child: TextFormField(
                    ...
                    style: widget.config.fieldStyle ??
                        TextStyle(
                          ...
                          color: _textColorAnimation.value ?? widget.fieldColors.textColor,
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: widget.config.showPlaceholder ? widget.config.placeholderCharacter : null,
                      hintStyle: widget.config.placeholderStyle ?? TextStyle(
